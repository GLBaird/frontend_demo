...
var indexFinalBuildRaplacements = [
    { pattern: /js\/app.js/i, replace: "js/app.min.js" },
    { pattern: /css\/styles.css/i, replace: "css/styles.min.css" },
    ...
    { pattern: /src=["'].+?\/jquery.+?.js["']/i,
        replace: "src='https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js'" },
    { pattern: /src=["'].+?\/bootstrap.+?.js["']/i,
        replace: "src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js'" },
    { pattern: /href=["'].+?\/bootstrap.+?.css["']/i,
        replace: "href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css'" }
];
